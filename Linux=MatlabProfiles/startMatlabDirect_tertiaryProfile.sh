...
export MATLAB_PREFDIR="/path/to/extracted/ZIP/tertiary"; #contains matlab.settings
export STARTUP_PATH="/path/to/extracted/ZIP"; #contains startup.m
export INITIAL_COMMAND="profileStartup('tertiary profile','grayed red->magenta');"
